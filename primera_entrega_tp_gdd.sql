...
CREATE FUNCTION StarTeam.Obtener_Viaje_Recorrido_ID (@CIUDAD_ORIGEN_DESCRIPCION NVARCHAR(255), @CIUDAD_DESTINO_DESCRIPCION NVARCHAR(255), @RECORRIDO_PRECIO decimal(18,2))
RETURNS int
AS
BEGIN
  ...
  SELECT @RECORRIDO_ORIGEN_ID = StarTeam.Obtener_Ciudad_ID(@CIUDAD_DESCRIPCION)
  SELECT @RECORRIDO_DESTINO_ID = StarTeam.Obtener_Ciudad_ID(@CIUDAD_DESCRIPCION)
...
BEGIN
  INSERT INTO StarTeam.Viaje (VIAJE_CAMION_NUMERO, 
          ...
          SELECT DISTINCT StarTeam.Obtener_Viaje_Camion_ID(CAMION_NUMERO), 
                          StarTeam.Obtener_Viaje_Recorrido_ID(RECORRIDO_NUMERO), 
                          CHOFER_NRO_LEGAJO,
                          VIAJE_FECHA_INICIO, 
                          VIAJE_FECHA_FIN,
                          VIAJE_CONSUMO_COMBUSTIBLE
