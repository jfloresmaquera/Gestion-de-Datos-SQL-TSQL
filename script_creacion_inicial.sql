...
AS
BEGIN
  SELECT DISTINCT  CAMION_PATENTE, RECORRIDO_CIUDAD_ORIGEN, RECORRIDO_CIUDAD_DESTINO, RECORRIDO_KM, RECORRIDO_PRECIO, CHOFER_NRO_LEGAJO, VIAJE_FECHA_INICIO, VIAJE_FECHA_FIN, VIAJE_CONSUMO_COMBUSTIBLE INTO #viaje_tmp
  FROM gd_esquema.Maestra
  WHERE CHOFER_NRO_LEGAJO IS NOT NULL
...
AS
BEGIN
	SELECT DISTINCT CAMION_PATENTE, VIAJE_FECHA_INICIO, PAQUETE_DESCRIPCION, PAQUETE_CANTIDAD INTO #paquete_temp
	FROM gd_esquema.Maestra
	WHERE PAQUETE_DESCRIPCION IS NOT NULL
...
AS
BEGIN
  SELECT DISTINCT CAMION_PATENTE,TALLER_CIUDAD, TALLER_NOMBRE, TALLER_MAIL, TALLER_TELEFONO, TALLER_DIRECCION, ORDEN_TRABAJO_ESTADO, ORDEN_TRABAJO_FECHA INTO #Orden_Trabajo_temp
  FROM gd_esquema.Maestra
...
AS
BEGIN
  SELECT DISTINCT CAMION_PATENTE, TALLER_CIUDAD, TALLER_NOMBRE, TALLER_MAIL, TALLER_TELEFONO, TALLER_DIRECCION, ORDEN_TRABAJO_ESTADO, ORDEN_TRABAJO_FECHA, TAREA_CODIGO, MECANICO_NRO_LEGAJO, TAREA_FECHA_INICIO_PLANIFICADO, TAREA_FECHA_INICIO, TAREA_FECHA_FIN INTO #Tarea_X_Orden_Trabajo_temp
  FROM gd_esquema.Maestra
  WHERE TAREA_CODIGO IS NOT NULL
  GROUP BY CAMION_PATENTE, TALLER_CIUDAD, TALLER_NOMBRE, TALLER_MAIL, TALLER_TELEFONO, TALLER_DIRECCION, ORDEN_TRABAJO_ESTADO, ORDEN_TRABAJO_FECHA, TAREA_CODIGO, MECANICO_NRO_LEGAJO, TAREA_FECHA_INICIO_PLANIFICADO, TAREA_FECHA_INICIO, TAREA_FECHA_FIN
  ...
  SELECT DISTINCT StarTeam.Obtener_Orden_Trabajo_ID(CAMION_PATENTE, TALLER_CIUDAD, TALLER_NOMBRE, TALLER_MAIL, TALLER_TELEFONO, TALLER_DIRECCION, ORDEN_TRABAJO_ESTADO, ORDEN_TRABAJO_FECHA), 
                  ...
                  TAREA_FECHA_INICIO,
                  TAREA_FECHA_FIN
  FROM #Tarea_X_Orden_Trabajo_temp
  WHERE ORDEN_TRABAJO_FECHA IS NOT NULL

  DROP TABLE #Tarea_X_Orden_Trabajo_temp
END
GO
